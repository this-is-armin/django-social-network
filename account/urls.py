...
urlpatterns = [
    ...
    path('<username>/saved_posts/', views.UserSavedPostsView.as_view(), name='user_saved_posts'),
    ...
    path('<username>/stories/<pk>/delete/', views.user_story_delete_view, name='user_story_delete'),
    ...
    path('<username>/links/<pk>/', views.user_link_delete_view, name='user_link_delete'),
]
